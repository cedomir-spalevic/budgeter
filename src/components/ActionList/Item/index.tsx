   ...
   if (props.item.leftSwipeContent) {
      leftSwipeContent = (
         <SwipeContainer
            ...
            icon={
               <Icon
                  name={props.item.leftSwipeContent.iconName}
   ...
   if (props.item.rightSwipeContent) {
      rightSwipeContent = (
         <SwipeContainer
            ...
            icon={
               <Icon
                  name={props.item.rightSwipeContent.iconName}
                  color={theme.value.palette.white}
                  size={28}
               />
            }
         ...
         >
            <View style={listItemStyle}>
               ...
               {props.item.action ? (
                  ...
                  <Icon
                     name={props.item.postIconName ?? "chevron-right"}
                     size={24}
                     color={props.item.postIconColor}
                  />
               )}
            </View>
         </TouchableHighlight>
