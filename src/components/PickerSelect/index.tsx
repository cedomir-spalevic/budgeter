...
const PickerSelect: React.FC<Props> = (props: Props) => {
   ...
   const pickerSelectRef = useRef<PickerSelectRef>({
   ...
   useEffect(() => {
      if (props.value && value === undefined) setValue(props.value);
...
export default forwardRef<PickerSelectRef, Props>((props, ref) => (
   <PickerSelect pickerSelectRef={ref} {...props} />
));
