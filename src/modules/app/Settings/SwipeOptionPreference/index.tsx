...
const SwipeOptionPreferencePage: React.FC = () => {
   const user = useUser();
   ...
   return (
      <Page>
         <Container allowScroll flex title={route.params?.title}>
            <ActionItem
               title={<Label type="header" text={route.params?.title} />}
            >
               <List
                  items={[
                     {
                        ...
                        action: (
                           <Checkbox
                              checked={
                                 user.swipeOptions[
                                    route.params?.swipeOptionKey
                                 ] === "left"
                              }
                           />
                        ),
                        onPress: async () =>
                           user.updateSwipeOptions({
                              ...user.swipeOptions,
                              [route.params?.swipeOptionKey]: "left"
                           })
                     },
                     {
                        ...
                        onPress: async () =>
                           user.updateSwipeOptions({
                              ...user.swipeOptions,
                              [route.params?.swipeOptionKey]: "right"
                           })
                     }
                  ]}
               />
...
export default SwipeOptionPreferencePage;
